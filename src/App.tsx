        ...
        <div className="lg:col-span-5 order-2 lg:order-1">
          <div className="space-y-12 md:space-y-20">
            ...
            <div className="space-y-10 text-base md:text-xl font-normal leading-relaxed text-ink italic tracking-wide">
              <p>
                Більше 8 років я спеціалізуюся на створенні щирих та виразних портретів. Моя філософія — це відмова від штучного позування на користь справжніх емоцій та життя у кадрі.
              </p>
              <p>
